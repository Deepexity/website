          ...
          <div className="space-y-8 animate-fade-in">
            <div className="space-y-4">
              ...
              <p className="text-xl text-muted-foreground max-w-lg">
                Your network, your future. Connect with top freelancers and find unlimited talents.
              </p>
            </div>
            ...
            <div className="flex items-center space-x-8">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="text-sm font-medium">100+ Freelancers</span>
              </div>
              <div className="flex items-center space-x-2">
            ...
            <div className="absolute -bottom-6 -left-6 bg-card border border-border rounded-xl p-6 shadow-elegant max-w-xs">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Successfully matched with expert</p>
                </div>
              </div>
            </div>
          </div>
