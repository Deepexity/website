...
import { Shield, Users, Zap, Award, Globe, TrendingUp } from "lucide-react";
  ...
  const features = [
    {
      ...
      description: "Our AI-powered algorithm connects you with the perfect freelancers in minutes."
    },
    {
      icon: Users,
    ...
    },
    {
      ...
      description: "All freelancers are vetted and verified with portfolio reviews and skill assessments."
    }
  ];
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-lg text-muted-foreground">
                ...
                and the freedom it brings to both businesses and freelancers.
              </p>
              <p className="text-muted-foreground">
                ...
                thousands of businesses find the perfect freelance talent.
              </p>
            </div>
